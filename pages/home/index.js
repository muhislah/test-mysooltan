...
export default function Home({ post }) {
  ...
  return (
    < >
      <Headers />
      <main className='py-3 md:px-28 px-10 w-100'>
        <div className='flex w-100 my-20 justify-center align-center gap-3 blur-none flex-col md:flex-row'>
        ...
        <div className='flex w-100 my-10 flex-col items-center'>
          ...
          <div className='flex gap-3 align-center mt-5 flex-col md:flex-row'>
